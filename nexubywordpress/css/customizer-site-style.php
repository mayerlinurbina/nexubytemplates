...
--custom-color-1: #f9f8c4;
--custom-color-1-darker: #f5f39c;
--custom-color-1-r: 249;
--custom-color-1-g: 248;
--custom-color-1-b: 196;
--custom-color-1-contrast: black;
--custom-color-1-contrast-darker: black;
--custom-color-1-text-color: var(--body-color);
--custom-color-2: #b4f07b;
--custom-color-2-darker: #a1ec5a;
--custom-color-2-r: 180;
--custom-color-2-g: 240;
--custom-color-2-b: 123;
--custom-color-2-contrast: black;
--custom-color-2-contrast-darker: black;
--custom-color-2-text-color: var(--body-color);
--custom-color-3: #f9dda1;
--custom-color-3-darker: #f7cf7a;
--custom-color-3-r: 249;
--custom-color-3-g: 221;
--custom-color-3-b: 161;
--custom-color-3-contrast: black;
--custom-color-3-contrast-darker: black;
--custom-color-3-text-color: var(--body-color);
--custom-color-4: #eed791;
--custom-color-4-darker: #e9cb70;
--custom-color-4-r: 238;
--custom-color-4-g: 215;
--custom-color-4-b: 145;
